...
function adminStyles(): string {
  return `
    ...
    * { box-sizing:border-box; }
    ...
    .delete-published { width:100%; margin-top:18px; border:1px solid #efcaca; border-radius:10px; padding:11px 14px; background:var(--danger-soft); color:var(--danger); font-weight:850; }
    .delete-published:hover { background:#f7dede; }
