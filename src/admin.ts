...
function adminStyles(): string {
  return `
    ...
    * { box-sizing:border-box; }
    ...
    .hero { width:100%; height:clamp(230px,42vw,420px); margin-bottom:24px; border-radius:14px; overflow:hidden; background:linear-gradient(145deg,#dce9e0,#eef4f0); display:grid; place-items:center; color:#6f8778; font-size:48px; }
    ...
    .ingredient-image { width:52px; height:52px; flex:none; overflow:hidden; border:1px solid var(--line); border-radius:10px; background:linear-gradient(145deg,#eef4f0,#f8faf9); display:grid; place-items:center; color:#6f8778; font-size:21px; }
    .ingredient-image img { width:100%; height:100%; object-fit:contain; }
